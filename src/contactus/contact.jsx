...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row px-6 md:px-20 py-25 md:py-28 lg:py-50">
      {/* LEFT SIDE */}
      <div className="md:w-1/2 w-full mb-10 md:mb-0">
        <h1 className="text-[60px] leading-[0.9] text-[#0a66c2] font-serif md:text-[100px]">
          Get in{" "}
        ...
        <div className="mt-10">
          ...
          <div className="flex items-center gap-3 text-[#0a66c2]">
            ...
            <p className="text-lg">PO Box 457, Cranebrook, NSW 2749</p>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-1/2 w-full align-bottom">
        ...
        >
          ...
          {/* Conditional: Hospital + Speciality */}
          {formData.is_doctor && (
            <>
              <input
                type="text"
          ...
          <div className="col-span-2 mt-4">
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-[#0c3633] text-white rounded-md hover:bg-[#0a2d2a] transition-all"
            >
          ...
          {successMsg && (
            <p className="text-green-600 text-sm mt-3 col-span-2">
              {successMsg}
            </p>
          )}
          {errorMsg && (
